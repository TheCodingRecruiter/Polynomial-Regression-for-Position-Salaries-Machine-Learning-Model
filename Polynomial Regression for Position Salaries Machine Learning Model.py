# -*- coding: utf-8 -*-
"""
Created on Mon Feb 19 09:22:30 2018
...
dataset = pd.read_csv(r'C:\Users\richa\MachineLearningProjects\Position_Salaries.csv')
X = dataset.iloc[:, 1:2].values # Matrix of Features
Y = dataset.iloc[:, 2].values # Dependent Variable/Target Values
